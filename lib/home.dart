...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return HomePage(userStream: _userStream);
  }
}
...
class HomePage extends StatelessWidget {
  const HomePage({
    Key? key,
    required Stream<QuerySnapshot<Object?>> userStream,
  }) : _userStream = userStream, super(key: key);

  final Stream<QuerySnapshot<Object?>> _userStream;
